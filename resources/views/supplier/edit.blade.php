        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-4 form-group">
                <label for="contact_parson">Contact person</label>
                <input type="text" id="contact_parson" name="contact_parson" class="form-control" value="{{$supplier->contact_parson}}">
              </div>
              <div class="col-md-4 form-group">
...
<script>
  var app = new Vue({
      ...
      data: {
          form: {
            image: "/images/supplier/{{ $supplier->img }}",
          },
          rows: [
                {}
            ]
