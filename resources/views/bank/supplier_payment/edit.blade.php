...
<section class="content">
  <form action="{{route('supplier-payment-edit',$supplier_payment->id)}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Supplier Payment information edit</h3>
            ...
            <div class="row">
              ...
              <div class="col-md-4 form-group">
                ...
                <select id="bank_account_id" name="bank_account_id" class="form-control">
                  ...
                  <option @if($bank_account->id==$supplier_payment->bank_account_id) selected @endif value="{{$bank_account->id}}">{{$bank_account->bank_name}}</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-4 form-group">
