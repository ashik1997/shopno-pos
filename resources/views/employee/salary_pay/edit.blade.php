...
<section class="content">
  <form action="{{route('salary-pay-edit',$salary_pay->id)}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="{{route('salary-pay-list')}}" class="btn btn-success float-right"><i class="fa fa-angle-double-left"></i> Back</a>
            </div>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-4 form-group">
                ...
                <select id="user_id" name="user_id" class="form-control">
                  ...
                  <option @if($employee->id==$salary_pay->user_id) selected @endif value="{{$employee->id}}">{{$employee->name}}</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-4 form-group">
                ...
                <select id="bank_account_id" name="bank_account_id" class="form-control">
                  ...
                  <option @if($bank_account->id==$salary_pay->bank_account_id) selected @endif value="{{$bank_account->id}}">{{$bank_account->bank_name}}</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-4 form-group">
